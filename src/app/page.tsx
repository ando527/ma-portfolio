  ...
  return (
    <>
      ...
      <section className="relative z-10 py-24 bg-[#100408]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.8fr] gap-16 items-start">
            ...
            >
              {/* Webflow */}
              <FadeItem className="bg-[#100408] p-8 hover:bg-white/[0.04] transition-colors duration-200">
      ...
      <section className="relative z-10 py-20 bg-background border-t border-maroon-100">
        <AnimateIn className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
